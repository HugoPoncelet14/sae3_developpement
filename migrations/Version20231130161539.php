 ...
 */
final class Version20231130161539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8BF24A7989312FE9 ON quantite (recette_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8BF24A7989312FE9 ON quantite');
